<template>
	<div class="park-gallery">
		<a
			...
			:key="image.org.placeholder"
			:href="image.org.sizes.window.url"
			:data-width="image.org.sizes.window.width"
			:data-height="image.org.sizes.window.height"
			target="_blank"
		>
			<lazy-image :image="image" ratio="3x2"></lazy-image>
		</a>
	</div>
</template>
